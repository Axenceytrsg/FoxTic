                ...
                <div class="shadow-box shadow-box-with-fixed-bottom-bar">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <!-- Hostname -->
                            <!-- TCP Port / Ping / DNS / SNMP only -->
                            <div v-if="monitor.type === 'port' || monitor.type === 'ping' || monitor.type === 'dns' || monitor.type === 'snmp'" class="my-3">
                            ...
                            <!-- Port -->
                            <!-- For TCP Port / SNMP -->
                            <div v-if="monitor.type === 'port' || monitor.type === 'snmp'" class="my-3">
...
<style lang="scss" scoped>
    ...
    // Amélioration du style des menus déroulants
    select.form-select {
    ...
    // Style du formulaire pour meilleure compatibilité avec l'interface flottante
    .shadow-box {
        border-radius: 12px;
        overflow: hidden;
    }
