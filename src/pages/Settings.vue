...
.settings-menu {
    ...
    .menu-item:hover {
        background: rgba(0, 0, 0, 0.05); // Remplace $highlight-white pour un effet de surbrillance léger
    ...
    .active .menu-item {
        background: rgba($primary, 0.1); // Remplace $highlight-white par une couleur basée sur primary
