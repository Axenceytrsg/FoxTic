...
<style lang="scss" scoped>
    ...
    .item {
        ...
        &:hover {
            background-color: rgba(0, 0, 0, 0.05); // Effet de surbrillance légère en mode clair
        }

        &.active {
            background-color: rgba($primary, 0.1); // Couleur d'arrière-plan pour l'élément actif
        }
    ...
    .dark {
        .item {
            ...
            &.active {
                background-color: rgba($primary, 0.15); // Couleur d'arrière-plan pour l'élément actif en mode sombre
            }
        }
    }
</style>
