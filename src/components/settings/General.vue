<template>
    <div>
        <form class="my-4" autocomplete="off" @submit.prevent="saveGeneral">
            ...
            <div class="mb-4">
                <label for="displayTimezone" class="form-label">
                    {{ $t("Display Timezone") }}
                </label>
                <select id="displayTimezone" v-model="$root.userTimezone" class="form-select">
                    <option value="auto">
            ...
            <!-- Server Timezone -->
            <div class="mb-4">
                <label for="serverTimezone" class="form-label">
                    {{ $t("Server Timezone") }}
                </label>
                <select id="serverTimezone" v-model="settings.serverTimezone" class="form-select">
            ...
            <!-- Chrome Executable -->
            <div class="mb-4">
                <label class="form-label" for="chromeExecutable">
                    {{ $t("chromeExecutable") }}
                </label>
