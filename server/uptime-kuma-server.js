...
// DO NOT IMPORT HERE IF THE MODULES USED `FoxTicServer.getInstance()`, put at the bottom of this file instead.
...
class FoxTicServer {
     ...
     * @returns {FoxTicServer} Server instance
     */
    static getInstance() {
        if (FoxTicServer.instance == null) {
            FoxTicServer.instance = new FoxTicServer();
        }
        return FoxTicServer.instance;
    }
    ...
    constructor() {
        ...
        // Set Monitor Types
        FoxTicServer.monitorTypeList["real-browser"] = new RealBrowserMonitorType();
        FoxTicServer.monitorTypeList["tailscale-ping"] = new TailscalePing();
        FoxTicServer.monitorTypeList["dns"] = new DnsMonitorType();
        FoxTicServer.monitorTypeList["mqtt"] = new MqttMonitorType();
        FoxTicServer.monitorTypeList["snmp"] = new SNMPMonitorType();
        FoxTicServer.monitorTypeList["mongodb"] = new MongodbMonitorType();
        FoxTicServer.monitorTypeList["rabbitmq"] = new RabbitMqMonitorType();
